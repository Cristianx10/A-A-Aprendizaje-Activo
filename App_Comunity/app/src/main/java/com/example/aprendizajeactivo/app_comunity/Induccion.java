                                                            ...
                                                            InduccionRegister.OnFragmentInteractionListener
{
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_induccion, menu);
        return true;
    }
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public static Fragment newInstance(int sectionNumber) {
            ...
            switch (sectionNumber){
                case 1:
                    fragment = new InduccionOpcion();
                    break;
                case 2:
                    fragment = new InduccionRol();
                    break;
                case 3:
                    fragment = new InduccionLogin();
                    break;
                case 4:
                    fragment = new InduccionRegister();
                    break;
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.fragment_induccion, container, false);
